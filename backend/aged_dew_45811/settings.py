"""
Django settings for aged_dew_45811 project.
...
ROOT_URLCONF = 'aged_dew_45811.urls'
...
WSGI_APPLICATION = 'aged_dew_45811.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_dew_45811 API",
    "DESCRIPTION": "API documentation for aged_dew_45811 App",
    "VERSION": "v1",
}
